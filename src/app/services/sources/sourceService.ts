...
export class sourceService {
	...
	update(novel: novelObj, numOfChapters: number): update {
		...
		return { updateChapters: updateChapters, startIndex: updateChapters.length }
	}
	...
	prepChapter(novel: novelObj, downloadID: number, title: string, chapterBody: string, currentPos: number, destPos: number): chapterObj {
	...
	addPropoganda(author: string): string {
		return "<br/><br/>" +
			...
			"<p>If possible, please support the author(s) of this novel: " + author + "</p>";
	}
}
