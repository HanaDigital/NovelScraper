...
class CoWuxiaPanel(wx.Panel):
    ...
    def run(self, url, cover, directory):
        os.chdir(directory)   #Set the correct working directory

        link = url
        cover = cover
        if cover == "":
            cover = f'{self.current_directory}/rsc/Novel Cover.png'
        ...
        try:
            ...
            for chapter in chapter_dictionaries:
                ...
                content += "<p>You can download more novels using the app here: github.com/dr-nyt/Translated-Novel-Downloader/releases</p>"
